...
import com.belajarjava.message.ResponseFile;
import com.belajarjava.message.ResponseMessage;
import com.belajarjava.models.entities.File;
import com.belajarjava.services.FileService;
...
public class FileController {
    ...
    public ResponseEntity<ResponseMessage> uploadFile(@RequestParam("file") MultipartFile file){
        ...
        try {
            ...
            message = "Upload file gagal" + file.getOriginalFilename() + "!";
    ...
    public ResponseEntity<List<ResponseFile>> getListFiles(){
        List<ResponseFile> files = fileService.getAllFiles().map(dbFile -> {
            String fileDownloadUri = ServletUriComponentsBuilder
                ...
                // .path("/files/")
                .path("D:\\Belajar Java\\Upload File")
                .path(dbFile.getId())
                .toUriString();
